...
//        Expected: 12/31/2021
        ...
        WebTableUtils.returnOrderDate(driver, "Ned Stark");

    }

    @Test
            public void returnOrderDateMyOwnPractice(){
        driver.get("https://practice.cydeo.com/web-tables");
        String johnDoeOrderDate = WebTableUtils.returnOrderDate2(driver, "John Doe");
        System.out.println("johnDoeOrder = " + johnDoeOrderDate);

        String samuelOrderDate = WebTableUtils.returnOrderDate2(driver, "Samuel Jackson");
        System.out.println("samuelOrderDate = " + samuelOrderDate);
